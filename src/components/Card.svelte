<script lang="ts">
  ...
  <button on:click={handleClick} on:keydown={handleKeyDown} class="flex flex-col items-center border border-gray-300 p-4 rounded-lg shadow bg-white w-72 h-96 cursor-pointer" aria-label={`Card ${label}`} role="button">
